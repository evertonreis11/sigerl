...
<div class="row" style="background-color: #385687; color: white; border-radius:5px;">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-9 col-xs-offset-3" style="color:white;">
		...
		<div class="row">
	        ...
	        <div class="form-group col-md-12" style="margin-top: 2%;">
	        	...
	        	<div class="col-xs-9 col-xs-offset-3" style="">
            		...
            		<button class="btn btn-primary btn-lg" type="button" id="buttonAcoes" data-toggle="modal" data-target="#modalAcoes" style="margin-left: 5%">Ações</button>
	            </div>
