...
public class ConsultaEstoque {
    ...
    @XmlElement(namespace = "http://tempuri.org/", required = true, nillable = true)
    protected List<EstoqueProduto> anyType;
     ...
     * 
     */
    public List<EstoqueProduto> getListaEstoque() {
        if (anyType == null) {
            anyType = new ArrayList<EstoqueProduto>();
        }
        return this.anyType;
    }
